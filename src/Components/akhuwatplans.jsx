            ...
            <ul className="list-group pb-4">
                <li className="py-3 list-group-item">
                    <p className="h4 fw-normal">
                        For loans less than Rs. 500,000, you have to pay an application fee of Rs. 7,700 up front.
                    </p>
                </li>
                <li className="py-3 list-group-item">
                    <p className="h4 fw-normal">
                ...
                <li className="py-3 list-group-item">
                    <p className="h4 fw-normal">
                        The Akhuwat Foundation will look over your loan request and send the money within two hours after receiving the application fee.
                    </p>
                </li>
                <li className="py-3 list-group-item">
                    <p className="h4 fw-normal">
                        Keep in mind that you can get your membership fee back in full. 
                    </p>
                </li>
            </ul>
